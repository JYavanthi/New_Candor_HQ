...
public partial class GuestHouseBooking
{
    ...
    public virtual ICollection<GuestHouseBookingParticipant> GuestHouseBookingParticipants { get; set; } = new List<GuestHouseBookingParticipant>();
}
