...
public partial class LvApplyRule
{
    ...
    public int? MissingPunchRequestCount { get; set; }

    public int? PerMinPerMonth { get; set; }

    public int? PerCountPerMonth { get; set; }

    public int? PerInMinMinutes { get; set; }

    public int? PerInMaxMinitues { get; set; }
}
