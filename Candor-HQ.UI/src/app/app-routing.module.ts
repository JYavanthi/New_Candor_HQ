...
const routes: Routes = [
  ...
  // Employee Login URL
  { path: 'empid/:empNumber', component: LoginComponent },
  ...
  // Issue Module
  {
    path: 'issue',
    loadChildren: () =>
      import('./issue-module/issue.module').then(m => m.IssueModule)
  },
  ...
  // Protected Routes
  {
    ...
    children: [
      ...
      },
      {
        path: 'changerequest',
        loadChildren: () =>
          import('./cr-module/cr-module.module').then(m => m.CrModuleModule),
      },
      {
        path: 'issue',
        loadChildren: () =>
      ...
      },
      {
        path: 'mastermodule',
        loadChildren: () =>
          import('./master-module/master-module.module').then(m => m.MasterModuleModule),
      },
      {
        path: 'assets',
        loadChildren: () =>
          import('./asset-module/asset-module.module').then(m => m.AssetModuleModule),
      },
      {
        path: '',
        loadChildren: () =>
          import('./project-managament-module/project-managament-module.module').then(m => m.ProjectManagamentModuleModule),
      }
    ]
  },
