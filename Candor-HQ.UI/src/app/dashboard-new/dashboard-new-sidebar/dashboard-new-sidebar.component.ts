...
@Component({
  selector: 'app-dashboard-new-sidebar',
  templateUrl: './dashboard-new-sidebar.component.html',
  styleUrl: './dashboard-new-sidebar.component.css'
})
export class DashboardNewSidebarComponent {
