...
@Component({
  selector: 'app-sidebrservicemodule',
  templateUrl: './sidebrservicemodule.component.html',
  styleUrl: './sidebrservicemodule.component.css'
})
export class SidebrservicemoduleComponent {
